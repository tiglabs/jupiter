...
void conhash_set_node(struct node_s *node, const char *iden, u_int replica, void *userdata)
{
...
struct node_s* conhash_lookup(struct conhash_s *conhash, const char *object, u_int length)
{
    long hash;
    ...
    /* calc hash value */
    hash = conhash->cb_hashfunc(object, length);
